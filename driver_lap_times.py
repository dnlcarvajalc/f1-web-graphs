...
class plot_lap_times:
    def __init__(self, year_race:int, round_race:int, driver_list:dict) -> None:
        self.year_race, self.round_race, self.driver_list = year_race, round_race, driver_list
        self.number_of_laps = utils.get_number_of_laps_done(self.year_race, self.round_race, BASE_URL)
    ...
    def plot_single_driver(self, full_df:pd.DataFrame, driver_name:str, color_plot:str, label_driver:str):
    ...
    def plot_graph(self):
        ...
        for driver in self.driver_list:
            self.plot_single_driver(self.all_laps_df, 
